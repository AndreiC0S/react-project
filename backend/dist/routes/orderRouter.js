...
orderRouter.post("/", jsonParser, [
    (0, check_1.check)('country').not().isEmpty(),
    (0, check_1.check)('address').not().isEmpty(),
    (0, check_1.check)('items').not().isEmpty(),
    ...
    orderModel.addProd(newOrder, (err, orderId) => {
        if (err) {
...
//edit product
orderRouter.put("/:id", jsonParser, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const editOrder = req.body;
    console.log("req.body", req.body);
    orderModel.update(editOrder, (err) => {
        if (err) {
