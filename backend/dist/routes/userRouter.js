...
//   ],
[
    (0, check_1.check)('nume').not().isEmpty().withMessage('Numele este obligatoriu'),
    (0, check_1.check)('prenume').not().isEmpty().withMessage('Prenumele este obligatoriu'),
    (0, check_1.check)('email').isEmail().withMessage('Adresa de email este invalidă').normalizeEmail({ gmail_remove_dots: false }),
    (0, check_1.check)('parola').matches(/^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[●!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~]).{7,}$/)
